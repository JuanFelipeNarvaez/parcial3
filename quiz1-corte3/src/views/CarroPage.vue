          ...
          <ion-modal :is-open="modalIsOpen" @didDismiss="modalIsOpen = false" :css-class="['my-custom-modal']">
            <div class="modal-content">
              <div id="data-form">
                ...
                <InputComponent v-model="categoriaId" id="categoriaId" name="categoriaId" label="Categoria: "/>
                <InputComponent v-model="usuarioId" id="usuarioId" name="usuarioId" label="Usuario: "/>
              </div>
              <div>
